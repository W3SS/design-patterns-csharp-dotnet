...
- Singleton pattern is actually considered an anti-pattern and overuse of it should be avoided. 
  ...
  because it introduces a global state in your application and change to it in one place could affect 
  in the other areas and it could become pretty difficult to debug. 
